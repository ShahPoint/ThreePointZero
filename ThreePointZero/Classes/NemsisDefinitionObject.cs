...
namespace ThreePointZero.Classes
{
    public static class NemsisDefinitionObject
    {
        ...
        public class NemsisDataElement
        {
            ...
            public string NemsisNumber { get; set; }
            public string NemsisName { get; set; }
            public string ElementTitle { get; set; }
            public string ngModel { get; set; }
            public string V2Number { get; set; }
            ...
            public string PNNill { get; set; }
            public string NVList { get; set; }
        ...
        public class NemsisMasterObject
        {
            public NemsisDataElement StateRequiredElement { get; set; }
            public NemsisDataElement CustomDataElementTitle { get; set; }
            public NemsisDataElement CustomDefinition { get; set; }
            public NemsisDataElement CustomDataType { get; set; }
            public NemsisDataElement CustomDataElementRecurrence { get; set; }
            public NemsisDataElement CustomDataElementUsage { get; set; }
            public NemsisDataElement CustomDataElementPotentialValues { get; set; }
            public NemsisDataElement CustomDataElementPotentialNOTValuesNV { get; set; }
            public NemsisDataElement CustomDataElementPotentialPertinentNegativeValuesPN { get; set; }
            public NemsisDataElement CustomDataElementGroupingID { get; set; }
            public NemsisDataElement EMSAgencyUniqueStateID { get; set; }
            public NemsisDataElement EMSAgencyNumber { get; set; }
            public NemsisDataElement EMSAgencyName { get; set; }
            public NemsisDataElement EMSAgencyState { get; set; }
            public NemsisDataElement EMSAgencyServiceAreaStates { get; set; }
            public NemsisDataElement EMSAgencyServiceAreaCountyies { get; set; }
            public NemsisDataElement EMSAgencyCensusTracts { get; set; }
            public NemsisDataElement EMSAgencyServiceAreaZIPCodes { get; set; }
            public NemsisDataElement PrimaryTypeofService { get; set; }
            public NemsisDataElement OtherTypesofService { get; set; }
            public NemsisDataElement LevelofService { get; set; }
            public NemsisDataElement OrganizationStatus { get; set; }
            public NemsisDataElement OrganizationalType { get; set; }
            public NemsisDataElement EMSAgencyOrganizationalTaxStatus { get; set; }
            public NemsisDataElement StatisticalCalendarYear { get; set; }
            public NemsisDataElement TotalPrimaryServiceAreaSize { get; set; }
            public NemsisDataElement TotalServiceAreaPopulation { get; set; }
            public NemsisDataElement _911EMSCallCenterVolumeperYear { get; set; }
            public NemsisDataElement EMSDispatchVolumeperYear { get; set; }
            public NemsisDataElement EMSPatientTransportVolumeperYear { get; set; }
            public NemsisDataElement EMSPatientContactVolumeperYear { get; set; }
            public NemsisDataElement EMSBillableCallsperYear { get; set; }
            public NemsisDataElement EMSAgencyTimeZone { get; set; }
            public NemsisDataElement EMSAgencyDaylightSavingsTimeUse { get; set; }
            public NemsisDataElement NationalProviderIdentifier { get; set; }
            public NemsisDataElement FireDepartmentIDNumber { get; set; }
            public NemsisDataElement AgencyContactType { get; set; }
            public NemsisDataElement AgencyContactLastName { get; set; }
            public NemsisDataElement AgencyContactFirstName { get; set; }
            public NemsisDataElement AgencyContactMiddleNameInitial { get; set; }
            public NemsisDataElement AgencyContactAddress { get; set; }
            public NemsisDataElement AgencyContactCity { get; set; }
            public NemsisDataElement AgencyContactState { get; set; }
            public NemsisDataElement AgencyContactZIPCode { get; set; }
            public NemsisDataElement AgencyContactCountry { get; set; }
            public NemsisDataElement AgencyContactPhoneNumber { get; set; }
            public NemsisDataElement AgencyContactEmailAddress { get; set; }
            public NemsisDataElement EMSAgencyContactWebAddress { get; set; }
            public NemsisDataElement AgencyMedicalDirectorDegree { get; set; }
            public NemsisDataElement AgencyMedicalDirectorBoardCertificationType { get; set; }
            public NemsisDataElement MedicalDirectorCompensation { get; set; }
            public NemsisDataElement EMSMedicalDirectorFellowshipTrainedStatus { get; set; }
            public NemsisDataElement StateAssociatedwiththeCertificationLicensureLevels { get; set; }
            public NemsisDataElement StateCertificationLicensureLevels { get; set; }
            public NemsisDataElement ProceduresPermittedbytheState { get; set; }
            public NemsisDataElement MedicationsPermittedbytheState { get; set; }
            public NemsisDataElement ProtocolsPermittedbytheState { get; set; }
            public NemsisDataElement EMSCertificationLevelsPermittedtoPerformEachProcedure { get; set; }
            public NemsisDataElement EMSAgencyProcedures { get; set; }
            public NemsisDataElement EMSCertificationLevelsPermittedtoAdministerEachMedication { get; set; }
            public NemsisDataElement EMSAgencyMedications { get; set; }
            public NemsisDataElement EMSAgencyProtocols { get; set; }
            public NemsisDataElement EMSAgencySpecialtyServiceCapability { get; set; }
            public NemsisDataElement BillingStatus { get; set; }
            public NemsisDataElement EmergencyMedicalDispatchEMDProvidedtoEMSAgencyServiceArea { get; set; }
            public NemsisDataElement EMDVendor { get; set; }
            public NemsisDataElement PatientMonitoringCapabilityies { get; set; }
            public NemsisDataElement CrewCallSign { get; set; }
            public NemsisDataElement DispatchCenterCADNameorID { get; set; }
            public NemsisDataElement EMSLocationType { get; set; }
            public NemsisDataElement EMSLocationName { get; set; }
            public NemsisDataElement EMSLocationNumber { get; set; }
            public NemsisDataElement EMSLocationGPS { get; set; }
            public NemsisDataElement EMSLocationUSNationalGridCoordinates { get; set; }
            public NemsisDataElement EMSLocationAddress { get; set; }
            public NemsisDataElement EMSLocationCity { get; set; }
            public NemsisDataElement EMSLocationState { get; set; }
            public NemsisDataElement EMSStationorLocationZIPCode { get; set; }
            public NemsisDataElement EMSLocationCounty { get; set; }
            public NemsisDataElement EMSLocationCountry { get; set; }
            public NemsisDataElement EMSLocationPhoneNumber { get; set; }
            public NemsisDataElement UnitVehicleNumber { get; set; }
            public NemsisDataElement VehicleIdentificationNumber { get; set; }
            public NemsisDataElement EMSUnitCallSign { get; set; }
            public NemsisDataElement VehicleType { get; set; }
            public NemsisDataElement CrewStateCertificationLicensureLevels { get; set; }
            public NemsisDataElement NumberofEachEMSPersonnelLevelonNormal911AmbulanceResponse { get; set; }
            public NemsisDataElement NumberofEachEMSPersonnelLevelonNormal911ResponseNonTransportVehicle { get; set; }
            public NemsisDataElement NumberofEachEMSPersonnelLevelonNormalMedicalNon911TransportAmbulance { get; set; }
            public NemsisDataElement VehicleInitialCost { get; set; }
            public NemsisDataElement VehicleModelYear { get; set; }
            public NemsisDataElement YearMilesKilometersHoursAccrued { get; set; }
            public NemsisDataElement AnnualVehicleHours { get; set; }
            public NemsisDataElement AnnualVehicleMilesKilometers { get; set; }
            public NemsisDataElement EMSPersonnelsLastName { get; set; }
            public NemsisDataElement EMSPersonnelsFirstName { get; set; }
            public NemsisDataElement EMSPersonnelsMiddleNameInitial { get; set; }
            public NemsisDataElement EMSPersonnelsMailingAddress { get; set; }
            public NemsisDataElement EMSPersonnelsCityofResidence { get; set; }
            public NemsisDataElement EMSPersonnelsState { get; set; }
            public NemsisDataElement EMSPersonnelsZIPCode { get; set; }
            public NemsisDataElement EMSPersonnelsCountry { get; set; }
            public NemsisDataElement EMSPersonnelsPhoneNumber { get; set; }
            public NemsisDataElement EMSPersonnelsEmailAddress { get; set; }
            public NemsisDataElement EMSPersonnelsDateofBirth { get; set; }
            public NemsisDataElement EMSPersonnelsGender { get; set; }
            public NemsisDataElement EMSPersonnelsRace { get; set; }
            public NemsisDataElement EMSPersonnelsCitizenship { get; set; }
            public NemsisDataElement EMSPersonnelsHighestEducationalDegree { get; set; }
            public NemsisDataElement EMSPersonnelsDegreeSubjectFieldofStudy { get; set; }
            public NemsisDataElement EMSPersonnelsMotorVehicleLicenseType { get; set; }
            public NemsisDataElement EMSPersonnelsImmunizationStatus { get; set; }
            public NemsisDataElement EMSPersonnelsImmunizationYear { get; set; }
            public NemsisDataElement EMSPersonnelsForeignLanguageAbility { get; set; }
            public NemsisDataElement EMSPersonnelsAgencyIDNumber { get; set; }
            public NemsisDataElement EMSPersonnelsStateofLicensure { get; set; }
            public NemsisDataElement EMSPersonnelsStatesLicensureIDNumber { get; set; }
            public NemsisDataElement EMSPersonnelsStateEMSCertificationLicensureLevel { get; set; }
            public NemsisDataElement EMSPersonnelsStateEMSCurrentCertificationDate { get; set; }
            public NemsisDataElement EMSPersonnelsInitialStatesLicensureIssueDate { get; set; }
            public NemsisDataElement EMSPersonnelsCurrentStatesLicensureExpirationDate { get; set; }
            public NemsisDataElement EMSPersonnelsNationalRegistryNumber { get; set; }
            public NemsisDataElement EMSPersonnelsNationalRegistryCertificationLevel { get; set; }
            public NemsisDataElement EMSPersonnelsCurrentNationalRegistryExpirationDate { get; set; }
            public NemsisDataElement EMSPersonnelsEmploymentStatus { get; set; }
            public NemsisDataElement EMSPersonnelsEmploymentStatusDate { get; set; }
            public NemsisDataElement EMSPersonnelsHireDate { get; set; }
            public NemsisDataElement EMSPersonnelsPrimaryEMSJobRole { get; set; }
            public NemsisDataElement EMSPersonnelsOtherJobResponsibilities { get; set; }
            public NemsisDataElement EMSPersonnelsTotalLengthofServiceinYears { get; set; }
            public NemsisDataElement EMSPersonnelsDateLengthofServiceDocumented { get; set; }
            public NemsisDataElement EMSPersonnelsPracticeLevel { get; set; }
            public NemsisDataElement DateofPersonnelsCertificationorLicensureforAgency { get; set; }
            public NemsisDataElement MedicalDeviceSerialNumber { get; set; }
            public NemsisDataElement MedicalDeviceNameorID { get; set; }
            public NemsisDataElement MedicalDeviceType { get; set; }
            public NemsisDataElement MedicalDeviceManufacturer { get; set; }
            public NemsisDataElement MedicalDeviceModelNumber { get; set; }
            public NemsisDataElement MedicalDevicePurchaseDate { get; set; }
            public NemsisDataElement TypeofFacility { get; set; }
            public NemsisDataElement FacilityName { get; set; }
            public NemsisDataElement FacilityLocationCode { get; set; }
            public NemsisDataElement HospitalDesignations { get; set; }
            public NemsisDataElement FacilityNationalProviderIdentifier { get; set; }
            public NemsisDataElement FacilityRoomSuiteorApartment { get; set; }
            public NemsisDataElement FacilityStreetAddress { get; set; }
            public NemsisDataElement FacilityCity { get; set; }
            public NemsisDataElement FacilityState { get; set; }
            public NemsisDataElement FacilityZIPCode { get; set; }
            public NemsisDataElement FacilityCounty { get; set; }
            public NemsisDataElement FacilityCountry { get; set; }
            public NemsisDataElement FacilityGPSLocation { get; set; }
            public NemsisDataElement FacilityUSNationalGridCoordinates { get; set; }
            public NemsisDataElement FacilityPhoneNumber { get; set; }
            public NemsisDataElement CustomDataElementResult { get; set; }
            public NemsisDataElement CustomElementIDReferenced { get; set; }
            public NemsisDataElement CorrelationIDofDemographicReportElementorGroup { get; set; }
            public NemsisDataElement PatientCareReportNumber { get; set; }
            public NemsisDataElement SoftwareCreator { get; set; }
            public NemsisDataElement SoftwareName { get; set; }
            public NemsisDataElement SoftwareVersion { get; set; }
            public NemsisDataElement IncidentNumber { get; set; }
            public NemsisDataElement EMSResponseNumber { get; set; }
            public NemsisDataElement TypeofServiceRequested { get; set; }
            public NemsisDataElement StandbyPurpose { get; set; }
            public NemsisDataElement PrimaryRoleoftheUnit { get; set; }
            public NemsisDataElement TypeofDispatchDelay { get; set; }
            public NemsisDataElement TypeofResponseDelay { get; set; }
            public NemsisDataElement TypeofSceneDelay { get; set; }
            public NemsisDataElement TypeofTransportDelay { get; set; }
            public NemsisDataElement TypeofTurnAroundDelay { get; set; }
            public NemsisDataElement EMSVehicleUnitNumber { get; set; }
            public NemsisDataElement LevelofCareofThisUnit { get; set; }
            public NemsisDataElement VehicleDispatchLocation { get; set; }
            public NemsisDataElement VehicleDispatchGPSLocation { get; set; }
            public NemsisDataElement VehicleDispatchLocationUSNationalGridCoordinates { get; set; }
            public NemsisDataElement BeginningOdometerReadingofRespondingVehicle { get; set; }
            public NemsisDataElement OnSceneOdometerReadingofRespondingVehicle { get; set; }
            public NemsisDataElement PatientDestinationOdometerReadingofRespondingVehicle { get; set; }
            public NemsisDataElement EndingOdometerReadingofRespondingVehicle { get; set; }
            public NemsisDataElement ResponseModetoScene { get; set; }
            public NemsisDataElement AdditionalResponseModeDescriptors { get; set; }
            public NemsisDataElement ComplaintReportedbyDispatch { get; set; }
            public NemsisDataElement EMDPerformed { get; set; }
            public NemsisDataElement EMDCardNumber { get; set; }
            public NemsisDataElement DispatchCenterNameorID { get; set; }
            public NemsisDataElement DispatchPriorityPatientAcuity { get; set; }
            public NemsisDataElement UnitDispatchedCADRecordID { get; set; }
            public NemsisDataElement CrewMemberID { get; set; }
            public NemsisDataElement CrewMemberLevel { get; set; }
            public NemsisDataElement CrewMemberResponseRole { get; set; }
            public NemsisDataElement PSAPCallDateTime { get; set; }
            public NemsisDataElement DispatchNotifiedDateTime { get; set; }
            public NemsisDataElement UnitNotifiedbyDispatchDateTime { get; set; }
            public NemsisDataElement DispatchAcknowledgedDateTime { get; set; }
            public NemsisDataElement UnitEnRouteDateTime { get; set; }
            public NemsisDataElement UnitArrivedonSceneDateTime { get; set; }
            public NemsisDataElement ArrivedatPatientDateTime { get; set; }
            public NemsisDataElement TransferofEMSPatientCareDateTime { get; set; }
            public NemsisDataElement UnitLeftSceneDateTime { get; set; }
            public NemsisDataElement ArrivalatDestinationLandingAreaDateTime { get; set; }
            public NemsisDataElement PatientArrivedatDestinationDateTime { get; set; }
            public NemsisDataElement DestinationPatientTransferofCareDateTime { get; set; }
            public NemsisDataElement UnitBackinServiceDateTime { get; set; }
            public NemsisDataElement UnitCanceledDateTime { get; set; }
            public NemsisDataElement UnitBackatHomeLocationDateTime { get; set; }
            public NemsisDataElement EMSCallCompletedDateTime { get; set; }
            public NemsisDataElement EMSPatientID { get; set; }
            public NemsisDataElement LastName { get; set; }
            public NemsisDataElement FirstName { get; set; }
            public NemsisDataElement MiddleInitialName { get; set; }
            public NemsisDataElement PatientsHomeAddress { get; set; }
            public NemsisDataElement PatientsHomeCity { get; set; }
            public NemsisDataElement PatientsHomeCounty { get; set; }
            public NemsisDataElement PatientsHomeState { get; set; }
            public NemsisDataElement PatientsHomeZIPCode { get; set; }
            public NemsisDataElement PatientsCountryofResidence { get; set; }
            public NemsisDataElement PatientHomeCensusTract { get; set; }
            public NemsisDataElement SocialSecurityNumber { get; set; }
            public NemsisDataElement Gender { get; set; }
            public NemsisDataElement Race { get; set; }
            public NemsisDataElement Age { get; set; }
            public NemsisDataElement AgeUnits { get; set; }
            public NemsisDataElement DateofBirth { get; set; }
            public NemsisDataElement PatientsPhoneNumber { get; set; }
            public NemsisDataElement PatientsEmailAddress { get; set; }
            public NemsisDataElement StateIssuingDriversLicense { get; set; }
            public NemsisDataElement DriversLicenseNumber { get; set; }
            public NemsisDataElement PrimaryMethodofPayment { get; set; }
            public NemsisDataElement PhysicianCertificationStatement { get; set; }
            public NemsisDataElement DatePhysicianCertificationStatementSigned { get; set; }
            public NemsisDataElement ReasonforPhysicianCertificationStatement { get; set; }
            public NemsisDataElement HealthcareProviderTypeSigningPhysicianCertificationStatement { get; set; }
            public NemsisDataElement LastNameofIndividualSigningPhysicianCertificationStatement { get; set; }
            public NemsisDataElement FirstNameofIndividualSigningPhysicianCertificationStatement { get; set; }
            public NemsisDataElement PatientResidesinServiceArea { get; set; }
            public NemsisDataElement InsuranceCompanyID { get; set; }
            public NemsisDataElement InsuranceCompanyName { get; set; }
            public NemsisDataElement InsuranceCompanyBillingPriority { get; set; }
            public NemsisDataElement InsuranceCompanyAddress { get; set; }
            public NemsisDataElement InsuranceCompanyCity { get; set; }
            public NemsisDataElement InsuranceCompanyState { get; set; }
            public NemsisDataElement InsuranceCompanyZIPCode { get; set; }
            public NemsisDataElement InsuranceCompanyCountry { get; set; }
            public NemsisDataElement InsuranceGroupID { get; set; }
            public NemsisDataElement InsurancePolicyIDNumber { get; set; }
            public NemsisDataElement LastNameoftheInsured { get; set; }
            public NemsisDataElement FirstNameoftheInsured { get; set; }
            public NemsisDataElement MiddleInitialNameoftheInsured { get; set; }
            public NemsisDataElement RelationshiptotheInsured { get; set; }
            public NemsisDataElement InsuranceGroupName { get; set; }
            public NemsisDataElement ClosestRelativeGuardianLastName { get; set; }
            public NemsisDataElement ClosestRelativeGuardianFirstName { get; set; }
            public NemsisDataElement ClosestRelativeGuardianMiddleInitialName { get; set; }
            public NemsisDataElement ClosestRelativeGuardianStreetAddress { get; set; }
            public NemsisDataElement ClosestRelativeGuardianCity { get; set; }
            public NemsisDataElement ClosestRelativeGuardianState { get; set; }
            public NemsisDataElement ClosestRelativeGuardianZIPCode { get; set; }
            public NemsisDataElement ClosestRelativeGuardianCountry { get; set; }
            public NemsisDataElement ClosestRelativeGuardianPhoneNumber { get; set; }
            public NemsisDataElement ClosestRelativeGuardianRelationship { get; set; }
            public NemsisDataElement PatientsEmployer { get; set; }
            public NemsisDataElement PatientsEmployersAddress { get; set; }
            public NemsisDataElement PatientsEmployersCity { get; set; }
            public NemsisDataElement PatientsEmployersState { get; set; }
            public NemsisDataElement PatientsEmployersZIPCode { get; set; }
            public NemsisDataElement PatientsEmployersCountry { get; set; }
            public NemsisDataElement PatientsEmployersPrimaryPhoneNumber { get; set; }
            public NemsisDataElement ResponseUrgency { get; set; }
            public NemsisDataElement PatientTransportAssessment { get; set; }
            public NemsisDataElement SpecialtyCareTransportCareProvider { get; set; }
            public NemsisDataElement AmbulanceTransportReasonCode { get; set; }
            public NemsisDataElement RoundTripPurposeDescription { get; set; }
            public NemsisDataElement StretcherPurposeDescription { get; set; }
            public NemsisDataElement AmbulanceConditionsIndicator { get; set; }
            public NemsisDataElement MileagetoClosestHospitalFacility { get; set; }
            public NemsisDataElement ALSAssessmentPerformedandWarranted { get; set; }
            public NemsisDataElement CMSServiceLevel { get; set; }
            public NemsisDataElement EMSConditionCode { get; set; }
            public NemsisDataElement CMSTransportationIndicator { get; set; }
            public NemsisDataElement TransportAuthorizationCode { get; set; }
            public NemsisDataElement PriorAuthorizationCodePayer { get; set; }
            public NemsisDataElement SupplyItemUsedName { get; set; }
            public NemsisDataElement NumberofSupplyItemsUsed { get; set; }
            public NemsisDataElement PayerType { get; set; }
            public NemsisDataElement FirstEMSUnitonScene { get; set; }
            public NemsisDataElement OtherEMSorPublicSafetyAgenciesatScene { get; set; }
            public NemsisDataElement OtherEMSorPublicSafetyAgencyIDNumber { get; set; }
            public NemsisDataElement TypeofOtherServiceatScene { get; set; }
            public NemsisDataElement DateTimeInitialResponderArrivedonScene { get; set; }
            public NemsisDataElement NumberofPatientsatScene { get; set; }
            public NemsisDataElement MassCasualtyIncident { get; set; }
            public NemsisDataElement TriageClassificationforMCIPatient { get; set; }
            public NemsisDataElement IncidentLocationType { get; set; }
            public NemsisDataElement IncidentFacilityCode { get; set; }
            public NemsisDataElement SceneGPSLocation { get; set; }
            public NemsisDataElement SceneUSNationalGridCoordinates { get; set; }
            public NemsisDataElement IncidentFacilityorLocationName { get; set; }
            public NemsisDataElement MilePostorMajorRoadway { get; set; }
            public NemsisDataElement IncidentStreetAddress { get; set; }
            public NemsisDataElement IncidentApartmentSuiteorRoom { get; set; }
            public NemsisDataElement IncidentCity { get; set; }
            public NemsisDataElement IncidentState { get; set; }
            public NemsisDataElement IncidentZIPCode { get; set; }
            public NemsisDataElement SceneCrossStreetorDirections { get; set; }
            public NemsisDataElement IncidentCounty { get; set; }
            public NemsisDataElement IncidentCountry { get; set; }
            public NemsisDataElement IncidentCensusTract { get; set; }
            public NemsisDataElement DateTimeofSymptomOnset { get; set; }
            public NemsisDataElement PossibleInjury { get; set; }
            public NemsisDataElement ComplaintType { get; set; }
            public NemsisDataElement Complaint { get; set; }
            public NemsisDataElement DurationofComplaint { get; set; }
            public NemsisDataElement TimeUnitsofDurationofComplaint { get; set; }
            public NemsisDataElement ChiefComplaintAnatomicLocation { get; set; }
            public NemsisDataElement ChiefComplaintOrganSystem { get; set; }
            public NemsisDataElement PrimarySymptom { get; set; }
            public NemsisDataElement OtherAssociatedSymptoms { get; set; }
            public NemsisDataElement ProvidersPrimaryImpression { get; set; }
            public NemsisDataElement ProvidersSecondaryImpressions { get; set; }
            public NemsisDataElement InitialPatientAcuity { get; set; }
            public NemsisDataElement WorkRelatedIllnessInjury { get; set; }
            public NemsisDataElement PatientsOccupationalIndustry { get; set; }
            public NemsisDataElement PatientsOccupation { get; set; }
            public NemsisDataElement PatientActivity { get; set; }
            public NemsisDataElement DateTimeLastKnownWell { get; set; }
            public NemsisDataElement CauseofInjury { get; set; }
            public NemsisDataElement MechanismofInjury { get; set; }
            public NemsisDataElement TraumaCenterCriteria { get; set; }
            public NemsisDataElement VehicularPedestrianorOtherInjuryRiskFactor { get; set; }
            public NemsisDataElement MainAreaoftheVehicleImpactedbytheCollision { get; set; }
            public NemsisDataElement LocationofPatientinVehicle { get; set; }
            public NemsisDataElement UseofOccupantSafetyEquipment { get; set; }
            public NemsisDataElement AirbagDeployment { get; set; }
            public NemsisDataElement HeightofFallfeet { get; set; }
            public NemsisDataElement OSHAPersonalProtectiveEquipmentUsed { get; set; }
            public NemsisDataElement ACNSystemCompanyProvidingACNData { get; set; }
            public NemsisDataElement ACNIncidentID { get; set; }
            public NemsisDataElement ACNCallBackPhoneNumber { get; set; }
            public NemsisDataElement DateTimeofACNIncident { get; set; }
            public NemsisDataElement ACNIncidentLocation { get; set; }
            public NemsisDataElement ACNIncidentVehicleBodyType { get; set; }
            public NemsisDataElement ACNIncidentVehicleManufacturer { get; set; }
            public NemsisDataElement ACNIncidentVehicleMake { get; set; }
            public NemsisDataElement ACNIncidentVehicleModel { get; set; }
            public NemsisDataElement ACNIncidentVehicleModelYear { get; set; }
            public NemsisDataElement ACNIncidentMultipleImpacts { get; set; }
            public NemsisDataElement ACNIncidentDeltaVelocity { get; set; }
            public NemsisDataElement ACNHighProbabilityofInjury { get; set; }
            public NemsisDataElement ACNIncidentPDOF { get; set; }
            public NemsisDataElement ACNIncidentRollover { get; set; }
            public NemsisDataElement ACNVehicleSeatLocation { get; set; }
            public NemsisDataElement SeatOccupied { get; set; }
            public NemsisDataElement ACNIncidentSeatbeltUse { get; set; }
            public NemsisDataElement ACNIncidentAirbagDeployed { get; set; }
            public NemsisDataElement CardiacArrest { get; set; }
            public NemsisDataElement CardiacArrestEtiology { get; set; }
            public NemsisDataElement ResuscitationAttemptedByEMS { get; set; }
            public NemsisDataElement ArrestWitnessedBy { get; set; }
            public NemsisDataElement CPRCareProvidedPriortoEMSArrival { get; set; }
            public NemsisDataElement WhoProvidedCPRPriortoEMSArrival { get; set; }
            public NemsisDataElement AEDUsePriortoEMSArrival { get; set; }
            public NemsisDataElement WhoUsedAEDPriortoEMSArrival { get; set; }
            public NemsisDataElement TypeofCPRProvided { get; set; }
            public NemsisDataElement FirstMonitoredArrestRhythmofthePatient { get; set; }
            public NemsisDataElement AnyReturnofSpontaneousCirculation { get; set; }
            public NemsisDataElement NeurologicalOutcomeatHospitalDischarge { get; set; }
            public NemsisDataElement DateTimeofCardiacArrest { get; set; }
            public NemsisDataElement DateTimeResuscitationDiscontinued { get; set; }
            public NemsisDataElement ReasonCPRResuscitationDiscontinued { get; set; }
            public NemsisDataElement CardiacRhythmonArrivalatDestination { get; set; }
            public NemsisDataElement EndofEMSCardiacArrestEvent { get; set; }
            public NemsisDataElement DateTimeofInitialCPR { get; set; }
            public NemsisDataElement BarrierstoPatientCare { get; set; }
            public NemsisDataElement LastNameofPatientsPractitioner { get; set; }
            public NemsisDataElement FirstNameofPatientsPractitioner { get; set; }
            public NemsisDataElement MiddleNameInitialofPatientsPractitioner { get; set; }
            public NemsisDataElement AdvanceDirectives { get; set; }
            public NemsisDataElement MedicationAllergies { get; set; }
            public NemsisDataElement EnvironmentalFoodAllergies { get; set; }
            public NemsisDataElement MedicalSurgicalHistory { get; set; }
            public NemsisDataElement MedicalHistoryObtainedFrom { get; set; }
            public NemsisDataElement ThePatientsTypeofImmunization { get; set; }
            public NemsisDataElement ImmunizationYear { get; set; }
            public NemsisDataElement CurrentMedications { get; set; }
            public NemsisDataElement CurrentMedicationDose { get; set; }
            public NemsisDataElement CurrentMedicationDosageUnit { get; set; }
            public NemsisDataElement CurrentMedicationAdministrationRoute { get; set; }
            public NemsisDataElement PresenceofEmergencyInformationForm { get; set; }
            public NemsisDataElement AlcoholDrugUseIndicators { get; set; }
            public NemsisDataElement Pregnancy { get; set; }
            public NemsisDataElement LastOralIntake { get; set; }
            public NemsisDataElement PatientCareReportNarrative { get; set; }
            public NemsisDataElement DateTimeVitalSignsTaken { get; set; }
            public NemsisDataElement ObtainedPriortothisUnitsEMSCare { get; set; }
            public NemsisDataElement CardiacRhythmElectrocardiographyECG { get; set; }
            public NemsisDataElement ECGType { get; set; }
            public NemsisDataElement MethodofECGInterpretation { get; set; }
            public NemsisDataElement SBPSystolicBloodPressure { get; set; }
            public NemsisDataElement DBPDiastolicBloodPressure { get; set; }
            public NemsisDataElement MethodofBloodPressureMeasurement { get; set; }
            public NemsisDataElement MeanArterialPressure { get; set; }
            public NemsisDataElement HeartRate { get; set; }
            public NemsisDataElement MethodofHeartRateMeasurement { get; set; }
            public NemsisDataElement PulseOximetry { get; set; }
            public NemsisDataElement PulseRhythm { get; set; }
            public NemsisDataElement RespiratoryRate { get; set; }
            public NemsisDataElement RespiratoryEffort { get; set; }
            public NemsisDataElement EndTidalCarbonDioxideETCO2 { get; set; }
            public NemsisDataElement CarbonMonoxideCO { get; set; }
            public NemsisDataElement BloodGlucoseLevel { get; set; }
            public NemsisDataElement GlasgowComaScoreEye { get; set; }
            public NemsisDataElement GlasgowComaScoreVerbal { get; set; }
            public NemsisDataElement GlasgowComaScoreMotor { get; set; }
            public NemsisDataElement GlasgowComaScoreQualifier { get; set; }
            public NemsisDataElement TotalGlasgowComaScore { get; set; }
            public NemsisDataElement Temperature { get; set; }
            public NemsisDataElement TemperatureMethod { get; set; }
            public NemsisDataElement LevelofResponsivenessAVPU { get; set; }
            public NemsisDataElement PainScaleScore { get; set; }
            public NemsisDataElement PainScaleType { get; set; }
            public NemsisDataElement StrokeScaleScore { get; set; }
            public NemsisDataElement StrokeScaleType { get; set; }
            public NemsisDataElement ReperfusionChecklist { get; set; }
            public NemsisDataElement APGAR { get; set; }
            public NemsisDataElement RevisedTraumaScore { get; set; }
            public NemsisDataElement DateTimeofLaboratoryorImagingResult { get; set; }
            public NemsisDataElement StudyResultPriortothisUnitsEMSCare { get; set; }
            public NemsisDataElement LaboratoryResultType { get; set; }
            public NemsisDataElement LaboratoryResult { get; set; }
            public NemsisDataElement ImagingStudyType { get; set; }
            public NemsisDataElement ImagingStudyResults { get; set; }
            public NemsisDataElement ImagingStudyFileorWaveformGraphicType { get; set; }
            public NemsisDataElement ImagingStudyFileorWaveformGraphic { get; set; }
            public NemsisDataElement EstimatedBodyWeightinKilograms { get; set; }
            public NemsisDataElement LengthBasedTapeMeasure { get; set; }
            public NemsisDataElement DateTimeofAssessment { get; set; }
            public NemsisDataElement SkinAssessment { get; set; }
            public NemsisDataElement HeadAssessment { get; set; }
            public NemsisDataElement FaceAssessment { get; set; }
            public NemsisDataElement NeckAssessment { get; set; }
            public NemsisDataElement ChestLungsAssessment { get; set; }
            public NemsisDataElement HeartAssessment { get; set; }
            public NemsisDataElement AbdominalAssessmentFindingLocation { get; set; }
            public NemsisDataElement AbdomenAssessment { get; set; }
            public NemsisDataElement PelvisGenitourinaryAssessment { get; set; }
            public NemsisDataElement BackandSpineAssessmentFindingLocation { get; set; }
            public NemsisDataElement BackandSpineAssessment { get; set; }
            public NemsisDataElement ExtremityAssessmentFindingLocation { get; set; }
            public NemsisDataElement ExtremitiesAssessment { get; set; }
            public NemsisDataElement EyeAssessmentFindingLocation { get; set; }
            public NemsisDataElement EyeAssessment { get; set; }
            public NemsisDataElement MentalStatusAssessment { get; set; }
            public NemsisDataElement NeurologicalAssessment { get; set; }
            public NemsisDataElement StrokeCVASymptomsResolved { get; set; }
            public NemsisDataElement ProtocolsUsed { get; set; }
            public NemsisDataElement ProtocolAgeCategory { get; set; }
            public NemsisDataElement DateTimeMedicationAdministered { get; set; }
            public NemsisDataElement MedicationAdministeredPriortothisUnitsEMSCare { get; set; }
            public NemsisDataElement MedicationGiven { get; set; }
            public NemsisDataElement MedicationAdministeredRoute { get; set; }
            public NemsisDataElement MedicationDosage { get; set; }
            public NemsisDataElement MedicationDosageUnits { get; set; }
            public NemsisDataElement ResponsetoMedication { get; set; }
            public NemsisDataElement MedicationComplication { get; set; }
            public NemsisDataElement MedicationCrewHealthcareProfessionalsID { get; set; }
            public NemsisDataElement RoleTypeofPersonAdministeringMedication { get; set; }
            public NemsisDataElement MedicationAuthorization { get; set; }
            public NemsisDataElement MedicationAuthorizingPhysician { get; set; }
            public NemsisDataElement DateTimeProcedurePerformed { get; set; }
            public NemsisDataElement ProcedurePerformedPriortothisUnitsEMSCare { get; set; }
            public NemsisDataElement Procedure { get; set; }
            public NemsisDataElement SizeofProcedureEquipment { get; set; }
            public NemsisDataElement NumberofProcedureAttempts { get; set; }
            public NemsisDataElement ProcedureSuccessful { get; set; }
            public NemsisDataElement ProcedureComplication { get; set; }
            public NemsisDataElement ResponsetoProcedure { get; set; }
            public NemsisDataElement ProcedureCrewMembersID { get; set; }
            public NemsisDataElement RoleTypeofPersonPerformingtheProcedure { get; set; }
            public NemsisDataElement ProcedureAuthorization { get; set; }
            public NemsisDataElement ProcedureAuthorizingPhysician { get; set; }
            public NemsisDataElement VascularAccessLocation { get; set; }
            public NemsisDataElement IndicationsforInvasiveAirway { get; set; }
            public NemsisDataElement DateTimeAirwayDevicePlacementConfirmation { get; set; }
            public NemsisDataElement AirwayDeviceBeingConfirmed { get; set; }
            public NemsisDataElement AirwayDevicePlacementConfirmedMethod { get; set; }
            public NemsisDataElement TubeDepth { get; set; }
            public NemsisDataElement TypeofIndividualConfirmingAirwayDevicePlacement { get; set; }
            public NemsisDataElement AirwayComplicationsEncountered { get; set; }
            public NemsisDataElement SuspectedReasonsforFailedAirwayManagement { get; set; }
            public NemsisDataElement DateTimeDecisiontoManagethePatientwithanInvasiveAirway { get; set; }
            public NemsisDataElement DateTimeInvasiveAirwayPlacementAttemptsAbandoned { get; set; }
            public NemsisDataElement DateTimeofEventperMedicalDevice { get; set; }
            public NemsisDataElement MedicalDeviceEventType { get; set; }
            public NemsisDataElement MedicalDeviceWaveformGraphicType { get; set; }
            public NemsisDataElement MedicalDeviceWaveformGraphic { get; set; }
            public NemsisDataElement MedicalDeviceModeManualAEDPacingCO2O2etc { get; set; }
            public NemsisDataElement MedicalDeviceECGLead { get; set; }
            public NemsisDataElement MedicalDeviceECGInterpretation { get; set; }
            public NemsisDataElement TypeofShock { get; set; }
            public NemsisDataElement ShockorPacingEnergy { get; set; }
            public NemsisDataElement TotalNumberofShocksDelivered { get; set; }
            public NemsisDataElement PacingRate { get; set; }
            public NemsisDataElement DestinationTransferredToName { get; set; }
            public NemsisDataElement DestinationTransferredToCode { get; set; }
            public NemsisDataElement DestinationStreetAddress { get; set; }
            public NemsisDataElement DestinationCity { get; set; }
            public NemsisDataElement DestinationState { get; set; }
            public NemsisDataElement DestinationCounty { get; set; }
            public NemsisDataElement DestinationZIPCode { get; set; }
            public NemsisDataElement DestinationCountry { get; set; }
            public NemsisDataElement DestinationGPSLocation { get; set; }
            public NemsisDataElement DestinationLocationUSNationalGridCoordinates { get; set; }
            public NemsisDataElement NumberofPatientsTransportedinthisEMSUnit { get; set; }
            public NemsisDataElement IncidentPatientDisposition { get; set; }
            public NemsisDataElement HowPatientWasMovedtoAmbulance { get; set; }
            public NemsisDataElement PositionofPatientDuringTransport { get; set; }
            public NemsisDataElement HowPatientWasTransportedFromAmbulance { get; set; }
            public NemsisDataElement EMSTransportMethod { get; set; }
            public NemsisDataElement TransportModefromScene { get; set; }
            public NemsisDataElement AdditionalTransportModeDescriptors { get; set; }
            public NemsisDataElement FinalPatientAcuity { get; set; }
            public NemsisDataElement ReasonforChoosingDestination { get; set; }
            public NemsisDataElement TypeofDestination { get; set; }
            public NemsisDataElement HospitalInPatientDestination { get; set; }
            public NemsisDataElement HospitalCapability { get; set; }
            public NemsisDataElement DestinationTeamPreArrivalAlertorActivation { get; set; }
            public NemsisDataElement DateTimeofDestinationPrearrivalAlertorActivation { get; set; }
            public NemsisDataElement DispositionInstructionsProvided { get; set; }
            public NemsisDataElement EmergencyDepartmentDisposition { get; set; }
            public NemsisDataElement HospitalDisposition { get; set; }
            public NemsisDataElement ExternalReportIDNumberType { get; set; }
            public NemsisDataElement ExternalReportIDNumber { get; set; }
            public NemsisDataElement OtherReportRegistryType { get; set; }
            public NemsisDataElement EmergencyDepartmentChiefComplaint { get; set; }
            public NemsisDataElement FirstEDSystolicBloodPressure { get; set; }
            public NemsisDataElement EmergencyDepartmentRecordedCauseofInjury { get; set; }
            public NemsisDataElement EmergencyDepartmentProcedures { get; set; }
            public NemsisDataElement EmergencyDepartmentDiagnosis { get; set; }
            public NemsisDataElement DateTimeofHospitalAdmission { get; set; }
            public NemsisDataElement HospitalProcedures { get; set; }
            public NemsisDataElement HospitalDiagnosis { get; set; }
            public NemsisDataElement TotalICULengthofStay { get; set; }
            public NemsisDataElement TotalVentilatorDays { get; set; }
            public NemsisDataElement DateTimeofHospitalDischarge { get; set; }
            public NemsisDataElement OutcomeatHospitalDischarge { get; set; }
            public NemsisDataElement CorrelationIDofPatientCareReportElementorGroup { get; set; }
            public NemsisDataElement ReviewRequested { get; set; }
            public NemsisDataElement PotentialSystemofCareSpecialtyRegistryPatient { get; set; }
            public NemsisDataElement PersonalProtectiveEquipmentUsed { get; set; }
            public NemsisDataElement EMSProfessionalCrewMemberID { get; set; }
            public NemsisDataElement SuspectedEMSWorkRelatedExposureInjuryorDeath { get; set; }
            public NemsisDataElement TheTypeofWorkRelatedInjuryDeathorSuspectedExposure { get; set; }
            public NemsisDataElement NaturalSuspectedIntentionalorUnintentionalDisaster { get; set; }
            public NemsisDataElement CrewMemberCompletingthisReport { get; set; }
            public NemsisDataElement ExternalElectronicDocumentType { get; set; }
            public NemsisDataElement FileAttachmentType { get; set; }
            public NemsisDataElement FileAttachmentImage { get; set; }
            public NemsisDataElement TypeofPersonSigning { get; set; }
            public NemsisDataElement SignatureReason { get; set; }
            public NemsisDataElement TypeOfPatientRepresentative { get; set; }
            public NemsisDataElement SignatureStatus { get; set; }
            public NemsisDataElement SignatureFileName { get; set; }
            public NemsisDataElement SignatureFileType { get; set; }
            public NemsisDataElement SignatureGraphic { get; set; }
            public NemsisDataElement DateTimeofSignature { get; set; }
            public NemsisDataElement SignatureLastName { get; set; }
            public NemsisDataElement SignatureFirstName { get; set; }

            public NemsisDataElement this[string propertyName]
            {
                get
                {
                    PropertyInfo property = GetType().GetProperty(propertyName);
                    return property.GetValue(this, null) as NemsisDataElement;
                }
                set
                {
                    PropertyInfo property = GetType().GetProperty(propertyName);
